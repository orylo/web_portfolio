...
export const projectDetails: Record<string, ProjectDetail> = {
  "brand-identity-cosmetic": {
    ...
    category: ["BRANDING", "PACKAGING", "GEN AI", "CONCEPT"],
  ...
  "editorial-magazine": {
    ...
    myRole: "100%",
    roleDescription: "매거진의 전반적인 편집 디자인을 담당했으며, 타이포그래피 디자인과 인쇄물 제작 과정을 주도적으로 진행함.",
    category: ["EDITORIAL", "GRAPHIC", "PHOTOGRAPHY"],
  ...
  "campaign-sustainability": {
    ...
    category: ["CONCEPT", "ART DIRECTION", "MOTION"],
  ...
  "exhibition-design": {
    ...
    category: ["EXHIBITION", "GRAPHIC", "PHOTOGRAPHY"],
  ...
  "package-design": {
    ...
    category: ["PACKAGING", "BRANDING", "ILLUSTRATION"],
  ...
  "brand-campaign": {
    ...
    category: ["BRANDING", "ART DIRECTION", "UI/UX"],
  ...
  "motion-graphics": {
    ...
    category: ["MOTION", "GRAPHIC", "ART DIRECTION"],
  ...
  "annual-report": {
    ...
    category: ["EDITORIAL", "GRAPHIC", "ILLUSTRATION"],
    toolsUsed: ["INDESIGN", "ILLUSTRATOR", "PHOTOSHOP"],
    projectHighlights: "숫자 너머에 담긴 진정한 가치. 데이터가 들려주는 한 해의 감동적인 스토리",
  ...
  "brand-guidelines": {
    ...
    category: ["BRANDING", "UI/UX", "GEN AI"],
